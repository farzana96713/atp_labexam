			...
			<div class="wrap-login100">
				...
				@csrf
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input  name="country" class="input100" type="text">
                   ...
                   <div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
						...
						<input   name="cost" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Phone Number is required">
						...
						<input   name="medium" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Address is required">
						<span class="label-input100">description</span>
						<input  name="description" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Address is required">
						<span class="label-input100">representation</span>
						<input  name="representation" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
