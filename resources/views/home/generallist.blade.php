...
<html>
  ...
  <body>
    <div class="testbox">
      <form method="post">
	  @csrf
        <u><center><h1>All General List</h1></center></u>
      
		<a type="button" class="btn btn-primary" href="{{route('home.addgeneral')}}">ADD General</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <a  class="btn btn-secondary" data-dismiss="modal">NO</a>
		...
		<a href="{{route('home.deletegeneral', $value['id'])}}">YES</a>
