		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(/images2/bg-01.jpg);">
					<a style="float: right;" type="button" href="{{route('home.scouthome')}}" class="btn btn-primary" > Back</a>
				</div>
				...
				@csrf
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input  value="{{$inf['country']}}" name="country" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					
					 <div class="wrap-input100 validate-input m-b-26" data-validate="Password is required">
						<span class="label-input100">place</span>
						<input value="{{$inf['place']}}"  name="place" class="input100" type="password">
						<span class="focus-input100"></span>
					</div>
				
                   <div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
						<span class="label-input100">cost</span>
						<input value="{{$inf['cost']}}"  name="cost" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Phone Number is required">
						...
						<input value="{{$inf['travelmedium']}}"  name="medium" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Address is required">
						<span class="label-input100">description</span>
						<input value="{{$inf['description']}}" name="description" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Address is required">
						<span class="label-input100">representation</span>
						<input value="{{$inf['representation']}}" name="representation" class="input100" type="text">
						<span class="focus-input100"></span>
					</div>
